...
public class ZoekenOpNummerServlet extends HttpServlet {
    ...
    private static final String VIEW = "/WEB-INF/JSP/zoekenopnummer.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getQueryString() != null) {
			...
			if(StringUtils.isLong(id)) {
				artikelRepository.read(Long.parseLong(id)).ifPresent(
								artikel -> request.setAttribute("artikel", artikel));
			} else {
